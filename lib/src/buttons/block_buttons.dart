...
class MicansBlockButtondfrger extends StatefulWidget {
  ...
  const MicansBlockButtondfrger.primary({
    Key? key,
    required this.text,
    this.icon,
  ...
  const MicansBlockButtondfrger.secondary({
    Key? key,
    required this.text,
    this.icon,
    required this.iconPosition,
  ...
  const MicansBlockButtondfrger.tertiary({
    Key? key,
    required this.text,
    this.icon,
    required this.iconPosition,
  ...
  const MicansBlockButtondfrger.transparent({
    Key? key,
    required this.text,
    this.icon,
    required this.iconPosition,
  ...
  const MicansBlockButtondfrger.danger({
    Key? key,
    required this.text,
    this.icon,
    required this.iconPosition,
  ...
  @override
  State<StatefulWidget> createState() => _MicansBlockButtondfrgerState();
}

class _MicansBlockButtondfrgerState extends State<MicansBlockButtondfrger> {
...
Widget _getDangerButton(MicansBlockButtondfrger widget) {
  return Container(
...
Widget _getTransparentButton(MicansBlockButtondfrger widget) {
  return Container(
    width: double.infinity,
    height: 48,
    decoration: BoxDecoration(
...
Widget _getTertiaryButton(MicansBlockButtondfrger widget) {
  return Container(
    width: double.infinity,
    height: 48,
    decoration: BoxDecoration(
...
Widget _getSecondaryButton(MicansBlockButtondfrger widget) {
  return Container(
    width: double.infinity,
    height: 48,
    decoration: BoxDecoration(
...
Widget _getPrimaryButton(MicansBlockButtondfrger widget) {
